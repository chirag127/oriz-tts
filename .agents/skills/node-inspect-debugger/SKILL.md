...
When you want to automate — set many breakpoints, capture scope state, script a repro — use `chrome-remote-interface`. Full reference: [`references/cdp-scripting.md`](./references/cdp-scripting.md).
...
The TUI is built Ink + tsx. Full reference: [`references/hermes-ui-tui.md`](./references/hermes-ui-tui.md).
...
Full reference: [`references/heap-cpu-profiles.md`](./references/heap-cpu-profiles.md).
...
Full reference: [`references/pitfalls-and-troubleshooting.md`](./references/pitfalls-and-troubleshooting.md).
...
- [ ] Source listing at pause shows the right file (mismatch = sourcemap issue, see pitfalls reference)
