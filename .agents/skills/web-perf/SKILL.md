...
| File                                               | Covers                                                                                                          |
| -------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| [`references/runtime.md`](references/runtime.md)   | Phase 1 trace, Phase 2 CWV thresholds + insight names, Phase 3 network analysis, Phase 4 accessibility snapshot |
| [`references/codebase.md`](references/codebase.md) | Phase 5 framework/bundler detection, tree-shaking, unused code, polyfills, compression                          |
