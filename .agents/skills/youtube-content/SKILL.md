...
Install the dependency via `uv` (works in any Python environment; Hermes-managed
env if running under Hermes):
...
See `references/output-formats.md` for detailed examples of each format.
