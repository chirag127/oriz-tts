> Folded from skill `workers-best-practices` on 2026-07-08 during skill-compact merge.
...
| Workers types | See `from-workers-best-practices-refs/review.md` for retrieval steps | API signatures, handler types, binding types |
...
- `from-workers-best-practices-refs/rules.md` — all best practice rules with code examples and anti-patterns
- `from-workers-best-practices-refs/review.md` — type validation, config validation, binding access patterns, review process
...
3. **Check types** — binding access, handler signatures, no `any`, no unsafe casts (see `from-workers-best-practices-refs/review.md`)
