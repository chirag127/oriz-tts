> Folded from skill `agents-sdk` on 2026-07-08 during skill-compact merge.
...
See `from-agents-sdk-refs/` for the full reference set (state-scheduling, callable, routing, configuration, streaming-chat, client-sdk, server-driven-messages, human-in-the-loop, workflows, durable-execution, queue-retries, mcp, email, webhooks-push, observability, think, voice, codemode, browse-the-web).
