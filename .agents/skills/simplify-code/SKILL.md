...
version: 1.0.0
author: Hermes Agent (inspired by Codex /simplify)
license: MIT
...
- "/simplify" (if they're carrying the Codex habit over)
...
- **Respect project conventions.** If the repo has AGENTS.md / AGENTS.md /
...
covers the complementary case: parallel review _during_ implementation, per
task. This skill is the standalone _after-the-fact_ cleanup pass. Use
`requesting-code-review` for the pre-commit security/quality gate.

<!-- Ported from Hermes 2026-07-09 -->
<!-- Sources merged: codebase/simplify-code, software-development/simplify-code (identical content) -->
