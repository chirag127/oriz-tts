...
Full command table — see [references/pdb-commands.md](references/pdb-commands.md).
...
Full patterns and DAP client script — see [references/debugpy-remote.md](references/debugpy-remote.md).

## Debugging Hermes-specific Processes

Applies to: tests, `run_agent.py`, `tui_gateway` subprocess, `_SlashWorker`, `gateway/run.py`.
...
Full per-process recipes — see [references/hermes-processes.md](references/hermes-processes.md).
...
Full pitfall list + post-debug verification checklist — see [references/pitfalls-and-verification.md](references/pitfalls-and-verification.md).
...
More one-shot recipes — see [references/one-shot-recipes.md](references/one-shot-recipes.md).
