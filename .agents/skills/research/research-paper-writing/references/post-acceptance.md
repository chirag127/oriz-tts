# Post-Acceptance & Workshop Papers

Maximize the impact of your accepted paper. Also: workshop/short paper guidance.
...
**Tools**: LaTeX (`beamerposter`), PowerPoint/Keynote, Figma, Canva.

**Production**: Order 2+ weeks before the conference. Fabric posters are lighter for travel. Many conferences now support virtual/digital posters.
...
Accessible summary significantly increases impact:
...
Workshop and short papers follow the same pipeline but with different constraints.
...
| **arXiv** | Post anytime | Timing matters |
