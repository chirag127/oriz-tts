...
For full checkpoint patterns, dataset artifacts, and model registry linking see `references/artifacts.md`.
...
For search strategies (grid/random/bayes), parameter distributions, early termination, and parallel execution see `references/sweeps.md`.
...
For full framework-specific examples (Fast.ai, XGBoost/LightGBM, PyTorch native, custom integrations) see `references/integrations.md`.
...
Full patterns, visualization/custom charts, reports, team collaboration, and pricing details in `references/best-practices.md`.
...
- `references/integrations.md` — Framework-specific examples (PyTorch, HF, Lightning, Keras, Fast.ai, XGBoost/LightGBM)
- `references/best-practices.md` — Organization, logging, visualization, collaboration, pricing
