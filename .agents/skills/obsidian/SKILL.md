...
> Note: Tool names below (`read_file`, `write_file`, `patch`, `search_files`, `terminal`) come from the Hermes runtime. On other agents, map them to the nearest equivalent: `Read`, `Write`, `Edit`, `Grep`/`Glob`, `Bash`/`PowerShell`.
